...
let 'partsneeded=40
console.log('1. Create partsNeeded variable with value of 40);


// 2. Create a variable called 'supplyChanges' whose value is an array containing
//    the following numbers: 3, 5, -6, 0, 7, 11.
let supplychangeArray= [3,5,-6,0,7,11];
console.log('2.created supplyChangesArray:');
...
let stretchPositiveArray = ();
  let stretchNegativeArray= ();
...
let totalParts = 0
let('i=0 + totalsparts = supplyChanges');
